    ...
    <div className="max-w-screen-xl m-auto px-4 py-12">
      ...
      <div className="grid gap-10 md:grid-cols-2 lg:grid-cols-3 not-[]:mt-12">
        {services.map((service) => (
          <div
            key={service.id}
            className="cursor-pointer flex flex-col items-center text-center p-4 sm:p-6 bg-bg-secondary border-border rounded-xl shadow hover:shadow-lg transition-shadow duration-300"
          >
            <img
              src={service.imgUrl}
              alt={service.title}
