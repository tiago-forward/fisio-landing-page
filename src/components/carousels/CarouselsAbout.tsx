...
export function CarouselsAbout() {
  ...
  return (
    <div className="relative mt-12">
      ...
      <button
        ref={prevRef}
        className="cursor-pointer hidden md:flex items-center justify-center absolute top-40 left-2 z-10 -translate-y-1/2 bg-bg-white text-txt-tertiary p-2 rounded-full shadow"
      >
        <ArrowLeft />
      </button>
      <button
        ref={nextRef}
        className="cursor-pointer hidden md:flex items-center justify-center absolute top-40 right-2 z-10 -translate-y-1/2 bg-bg-white text-txt-tertiary p-2 rounded-full shadow"
      >
        <ArrowRight />
      </button>
    </div>
